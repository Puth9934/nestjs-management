...
export class RigisterController {
  constructor(private rigisterService: RigisterService) {}

  // ... other methods ...

  @ApiOperation({ description: 'Create a new user without requiring a token' })
  @ApiGlobalResponse(UserResponseDto)
  @Post('public')
  public createUserWithoutToken(@Body(ValidationPipe) userDto: CreateUserRequestDto): Promise<UserResponseDto> {
    return this.rigisterService.createUserWithoutToken(userDto);
  }
}
